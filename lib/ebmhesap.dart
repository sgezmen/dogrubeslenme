...
class EbmHesap extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _EbmHesapState();
}

class _EbmHesapState extends State {
  ...
  Hesapla(int boy, int kilo, int yas,) {
    double boy_m = (boy * 5.03);
    double kilo_m = (kilo * 13.75);
    double yas_m = (yas * 6.75);
    double hesapSonucu = 66.5 + kilo_m + boy_m - yas_m;
    String snc = "";
